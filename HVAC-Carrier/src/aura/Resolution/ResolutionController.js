({
    ...
    saveCaseAndClose : function(component, event, helper) {
        ...
        var actionclaim = component.get("c.getClaimCases");
        actionclaim.setParams({
            "id" : component.get("v.recordId")
        });
        actionclaim.setCallback(this, function(a) {
            if (a.getState() == "SUCCESS") {
                component.set("v.ClaimCases", a.getReturnValue());
                // alert('Isclaim2'+component.get("v.ClaimCases"));
                ...
                if(component.get("v.CaseOwner") == '00G1C000003oCVwUAM' && component.get("v.RecordType") == 'Equipment' && component.get("v.ClaimCases")== false )
                {
                ...
                if(component.get("v.RecordType") == 'Equipment' && component.get("v.CaseOwner") != '00G1C000003oCVwUAM' && component.get("v.ClaimCases")== false)
                {
                    // alert('Isclaim'+component.get("v.ClaimCases"));
                    // alert('equipment');
                    var action5 = component.get("c.getPurposeCount");
                    action5.setParams({
                        "id" : component.get("v.recordId")
                ...
                if(component.get("v.RecordType") == 'Replacement Component (RC)'  && component.get("v.ClaimCases")== false)
                {
                    // alert('rc');
                    var action5 = component.get("c.getPurposeCount");
                    action5.setParams({
                ...
                if((component.get("v.RecordType") == 'Equipment'|| component.get("v.RecordType") == 'Replacement Component (RC)') && component.get("v.ClaimCases")== true)
                {
                    // alert('equipment claim');
                    var action5 = component.get("c.getPurposeCount");
                    action5.setParams({
                        "id" : component.get("v.recordId")
                    });
                    ...
                    action6.setCallback(this, function(a) {
                        if (a.getState() == "SUCCESS") {
                            ...
                            if(component.find("rcode").get("v.value") == '---None---' || component.find("rcode").get("v.value") == undefined  || component.get("v.PurposeCount") == false || component.get("v.ContactVal") == false )
                            {
                                if(component.find("rcode").get("v.value") == '---None---' || component.find("rcode").get("v.value") == undefined){
                                    component.set("v.displayResolution",true);  
                                }
